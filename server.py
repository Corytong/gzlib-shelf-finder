...
FALLBACK_LIBRARIES = [
    {"libcode": "GT", "simpleName": "广州图书馆", "name": "广州图书馆", "plibcode": ""},
    {"libcode": "GS", "simpleName": "少年儿童馆", "name": "广州少年儿童图书馆", "plibcode": ""},
    {"libcode": "YT", "simpleName": "阅创空间", "name": "广州图书馆阅创空间", "plibcode": ""},
]
    ...
    def do_GET(self):
        try:
            ...
            if parsed.path == "/api/health":
                return self.respond_json({"ok": True, "service": "gzlib-shelf-finder"})
